  ...
  for(int i=0; i<15;i++)
   {
     ...
     PORTA=leds[i].Bit_stateA;
     PORTB=leds[i].Bit_stateB;
     PORTC=leds[i].Bit_stateC;
     PORTL=leds[i].Bit_stateL;
     delay(80);
 ...
 for(int j=15; j>0;j--)
   {
     ...
     PORTA=leds[j-1].Bit_stateA;
     PORTB=leds[j-1].Bit_stateB;
     PORTC=leds[j-1].Bit_stateC;
     PORTL=leds[j-1].Bit_stateL;
     delay(80);
   }
}
